...
•- 𝓢𝓞𝓤𝓡𝓒𝓔 :  @SOURCE_NEON   
—————————————— ''')
                    await event.client.send_message("@R_R_B0", f'''[  • -𝓓𝓸𝓷𝓮 𝓗𝓾𝓷𝓽𝓮𝓻 𝓤𝓼𝓮𝓻 .](https://t.me/vd_d_d/20)
•- 𝓢𝓸𝓸𝓻𝔂 𝓘 𝓣𝓸𝓹 𝓞𝓷𝓮 #1 
——————————————
•- 𝓓𝓔𝓥 :   @R_R_B0                           
——————————————
...
—————————————— ''')
                    ...
                    try:
                    	...
                    	await sython.send_message("Flllood_1500_bot",f'''[  • -𝓓𝓸𝓷𝓮 𝓗𝓾𝓷𝓽𝓮𝓻 𝓤𝓼𝓮𝓻 .](https://t.me/vd_d_d/20)
•- 𝓢𝓸𝓸𝓻𝔂 𝓘 𝓣𝓸𝓹 𝓞𝓷𝓮 #1 
——————————————
•- 𝓓𝓔𝓥 :   @R_R_B0                           
——————————————
            ...
            for i in range(int(msg[0])):
                ...
                if "Available" in isav:
                    try:
                        await sython(functions.channels.UpdateUsernameRequest(
                            channel=ch, username=username))
                        await event.client.send_message(event.chat_id, f'''• -𝓓𝓸𝓷𝓮 𝓗𝓾𝓷𝓽𝓮𝓻 𝓤𝓼𝓮𝓻 
•- 𝓢𝓸𝓸𝓻𝔂 𝓘 𝓣𝓸𝓹 𝓞𝓷𝓮 #1 
——————————————
•- 𝓓𝓔𝓥 :   @R_R_B0                           
——————————————
...
—————————————— ''')
        ...
        if msg[0] == "يدوي":  # تثبيت يدوي يوزر قناة
            ...
            try:
                await sython(functions.channels.UpdateUsernameRequest(
                    channel=ch, username=username))
                await event.client.send_message(event.chat_id, f'''[  WELCOME TO SOURCE VENOM .](https://t.me/vd_d_d/20) • -𝓓𝓸𝓷𝓮 𝓗𝓾𝓷𝓽𝓮𝓻 𝓤𝓼𝓮𝓻 
•- 𝓢𝓸𝓸𝓻𝔂 𝓘 𝓣𝓸𝓹 𝓞𝓷𝓮 #1 
——————————————
•- 𝓓𝓔𝓥 :   @R_R_B0                           
——————————————
